...
import { Copy, Check, ArrowRight, Clock, CheckCircle } from "lucide-react";
...
export default function AddFundsModal() {
  ...
  const [step, setStep] = useState<
    "amount" | "address" | "pending" | "complete"
  >("amount");
  ...
  useEffect(() => {
    if (bridgeTransaction) {
      const tx = recentDemoTransactions.find(
        (t) => t.id === bridgeTransaction.id
      );
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex justify-between text-sm">
              <span className="text-secondary">
                ≈ ${((parseFloat(btcAmount) || 0) * 65000).toLocaleString()} USD
              </span>
          ...
          <div className="p-4 bg-[rgb(0,122,255)]/10 rounded-[12px] border border-[rgb(0,122,255)]/20">
            <p className="body-secondary text-secondary">
              Your Bitcoin will be bridged to Starknet and converted to USDC for
              yield farming.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="p-4 bg-[rgb(10,10,15)] rounded-[12px] border border-[rgb(45,45,55)]">
            <div className="flex justify-between">
              ...
              <span className="body-secondary text-primary">
                {btcAmount} BTC
              </span>
            </div>
            <div className="flex justify-between">
              ...
              <span className="body-secondary text-primary">
                ≈ ${((parseFloat(btcAmount) || 0) * 65000).toLocaleString()}
              </span>
            </div>
          </div>
          ...
          <div className="p-4 bg-[rgb(0,122,255)]/10 rounded-[12px] border border-[rgb(0,122,255)]/20">
            <p className="body-secondary text-secondary">
              ...
              1 block confirmation and bridged to Starknet USDC.
            </p>
          </div>
        </div>
      )}
        ...
        <div className="flex flex-col gap-6 items-center text-center">
          ...
          <div className="w-full p-4 bg-[rgb(10,10,15)] rounded-[12px]">
            ...
            <div className="flex justify-between">
              ...
              <span className="body-secondary text-[rgb(255,159,10)]">
                Confirming...
              </span>
            </div>
          </div>
      ...
      {step === "complete" && (
        <div className="flex flex-col gap-6 items-center text-center">
          <div className="w-16 h-16 rounded-full bg-[rgb(48,209,88)]/20 flex items-center justify-center">
            <CheckCircle
              className="w-8 h-8 text-[rgb(48,209,88)]"
              strokeWidth={1.5}
            />
          </div>
          ...
          <div className="w-full p-4 bg-[rgb(10,10,15)] rounded-[12px]">
            ...
            <div className="flex justify-between">
              ...
              <span className="body-secondary text-[rgb(48,209,88)]">
                ${((parseFloat(btcAmount) || 0) * 65000).toLocaleString()} USDC
              </span>
            </div>
          </div>
