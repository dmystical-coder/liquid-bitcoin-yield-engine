...
export default function MoreScreen() {
  ...
  const walletStatus = useMemo(() => {
    ...
    switch (user.walletType) {
      case "xverse":
        return "Linked: Xverse Wallet";
      case "unisat":
        return "Linked: Unisat Wallet";
      default:
  ...
  const getScreenTitle = () => {
    switch (currentScreen) {
      ...
      case "security":
        return "Security";
      case "wallets":
        return "Linked Accounts & Wallets";
      case "transactions":
            ...
            <div className="p-6 bg-[rgb(25,25,35)] rounded-[16px] border border-[rgb(45,45,55)]">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-3 bg-[rgb(10,10,15)] rounded-[12px]">
                  <p className="body-secondary text-secondary mb-1">
                    Total Balance
                  </p>
                ...
                <div className="p-3 bg-[rgb(10,10,15)] rounded-[12px]">
                  ...
                  <p className="body-primary text-[rgb(48,209,88)]">
                    ${dashboardData?.totalYieldEarned || "0.00"}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="p-4 bg-[rgb(25,25,35)] rounded-[12px] border border-[rgb(45,45,55)]">
                <div className="flex justify-between items-center mb-2">
                  <span className="body-secondary text-secondary">
                    Account ID
                  </span>
                  <button
                ...
                <p className="body-primary text-primary font-mono text-sm">
                  {user.id || "N/A"}
                </p>
              </div>
              ...
              <div className="p-4 bg-[rgb(25,25,35)] rounded-[12px] border border-[rgb(45,45,55)]">
                ...
                <p className="body-primary text-primary capitalize">
              ...
              <div className="p-4 bg-[rgb(25,25,35)] rounded-[12px] border border-[rgb(45,45,55)]">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="body-secondary text-secondary">
                      View your managed account private key
                    </p>
                  </div>
                  <Button
                    variant="secondary"
                ...
                {showPrivateKey && (
                  <div className="mt-4 p-3 bg-[rgb(255,69,58)]/10 rounded-[8px] border border-[rgb(255,69,58)]/20">
                    <p className="body-secondary text-[rgb(255,69,58)] mb-2">
                      ⚠️ Demo Private Key (Not Real)
                    </p>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="p-4 bg-[rgb(25,25,35)] rounded-[16px] border border-[rgb(45,45,55)]">
              <div className="flex items-center gap-3 mb-4">
                <Wallet
                  className="w-6 h-6 text-[rgb(0,122,255)]"
                  strokeWidth={1.5}
                />
              ...
              {user.walletType ? (
                ...
                <div className="flex flex-col gap-3">
                  <div className="p-3 bg-[rgb(255,159,10)]/10 rounded-[12px] border border-[rgb(255,159,10)]/20">
                    <p className="body-primary text-[rgb(255,159,10)] mb-1">
                      No Wallet Linked
                    </p>
                    <p className="body-secondary text-secondary">
        ...
        {currentScreen === "transactions" && (
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
              {recentDemoTransactions
                .filter(
                  (tx) => selectedFilter === "all" || tx.type === selectedFilter
                )
                .filter(
                  (tx) =>
                    !searchQuery ||
                ...
                .map((tx) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      <div className="flex-1">
                        <p className="body-primary text-primary mb-1">
                          {tx.description}
                        </p>
                        <p className="body-secondary text-secondary text-sm">
                          {new Date(tx.timestamp).toLocaleDateString()} •{" "}
                          {tx.protocol || tx.token}
                        </p>
                      </div>
                      <div className="text-right">
                        <p className="body-primary text-primary">
                          {tx.type === "withdraw" ||
                          tx.type === "lightning_payment"
                            ? "-"
                            : "+"}
                          {tx.amount} {tx.token}
                        </p>
                        <p
                          className={`body-secondary text-sm capitalize ${
                            tx.status === "confirmed"
                              ? "text-[rgb(48,209,88)]"
                              : tx.status === "pending"
                              ? "text-[rgb(255,159,10)]"
              ...
              {recentDemoTransactions.length === 0 && (
                <div className="p-8 text-center">
                  <FileText
                    ...
                    strokeWidth={1}
                  />
                  <p className="body-primary text-secondary">
                    No transactions yet
                  </p>
                  <p className="body-secondary text-secondary">
                    Start by adding funds to see your transaction history
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="flex flex-col gap-6">
              ...
              {[
                {
                  ...
                  answer:
                    "Use the 'Add Funds' button to get a deposit address. Send Bitcoin to bridge it to Starknet USDC for yield farming.",
                },
                {
                  question: "What yield strategies are available?",
                  answer:
                    "We offer Vesu lending, Nostra LP farming, Ekubo concentrated liquidity, and other DeFi protocols on Starknet.",
                },
                {
                  question: "How do Lightning payments work?",
                  answer:
                    "You can pay Lightning invoices directly from your USDC balance. The app handles the conversion automatically.",
                },
                {
                  question: "Is my Bitcoin safe?",
                  answer:
                    "Your funds are secured by Starknet's account abstraction and can only be moved with your explicit approval.",
                },
              ].map((faq, index) => (
                <div
                  key={index}
                  className="p-4 bg-[rgb(25,25,35)] rounded-[12px] border border-[rgb(45,45,55)]"
                >
                  <p className="body-primary text-primary mb-2">
                    {faq.question}
                  </p>
            ...
            <div className="p-4 bg-[rgb(10,10,15)] rounded-[12px] border border-[rgb(45,45,55)]">
              ...
              <p className="body-secondary text-secondary text-xs mt-2">
                Built with Starknet Account Abstraction, Sats Connect, and
                Atomiq Bridge
              </p>
            </div>
          </div>
